...
const alertVariants = cva(
    "relative grid w-full items-center gap-x-2 gap-y-0.5 text-pretty rounded-xl p-3 text-card-foreground text-xs has-[>svg]:has-data-[slot=alert-action]:grid-cols-[calc(var(--spacing)*5)_1fr_auto] has-[>svg]:grid-cols-[calc(var(--spacing)*5)_1fr] has-data-[slot=alert-action]:grid-cols-[1fr_auto] has-[>svg]:gap-x-2 [&>svg]:size-5",
    {
        defaultVariants: {
            variant: "default",
        },
