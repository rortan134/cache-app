                    ...
                    <div className="flex w-full max-w-5xl flex-col gap-12 p-8 pb-0 2xl:mx-auto">
                        <div className="relative aspect-video w-full overflow-hidden rounded-2xl border border-border/70 bg-muted">
                            <div aria-live="polite" className="sr-only">
                                <T>
                                    ...
                                    for sighted users showing the Cache App
                                    interface. The interface is displayed over a
                                    subtle, solid brand background.
                                </T>
                            </div>
                            <Image
                                alt=""
                            ...
                            <div className="flex max-w-[340px] flex-col gap-3 py-5 md:gap-4">
                                <T context="Library">
                                    <h2 className="font-medium text-[28px] text-foreground leading-[1.1] tracking-[-1.28px] lg:text-[32px]">
                                        Curate a library of all the content you
                                        love
                                    </h2>
                                    <p className="text-pretty font-medium text-base text-foreground leading-[1.2] tracking-[-3%] opacity-50">
                                        Get inspired, find that lesson, recipe,
                                        or idea you've been looking for, all in
                                ...
                                <ul className="mt-2 flex flex-col space-y-2 text-xs">
                                    <T context="Features">
                                        <li className="flex items-center gap-2">
                                            ...
                                            <span>
                                                Search by asking and Cache will
                                                find what you need
                                            </span>
                                        </li>
                                        <li className="flex items-center gap-2">
                        ...
                        <section className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 md:gap-[40px]">
                            <div className="flex max-w-[340px] flex-col gap-3 py-5 md:gap-4">
                                <T context="Integrations">
                                    ...
                                    <p className="text-pretty font-medium text-base text-foreground leading-[1.2] tracking-[-3%] opacity-50">
                                        Bring together bookmarks from your
                                        browser, socials, and videos
                                        automatically. Ditch the endless
                                        scrolling and tabbing through multiple
                                        platforms to find what matters most to
                                        you.
                                    </p>
                                </T>
                                <ul className="mt-2 flex flex-col space-y-2 text-xs">
                            ...
                            <div className="flex max-w-[340px] flex-col gap-3 py-5 md:gap-4">
                                <T context="Habits">
                                    ...
                                    <p className="text-pretty font-medium text-base text-foreground leading-[1.2] tracking-[-3%] opacity-50">
                                        ...
                                        only to let them fade into a forgotten
                                        list. Cache brings your best saved
                                        content back to you when it's most
                                        useful.
                                    </p>
                                </T>
                                <ul className="mt-2 flex flex-col space-y-2 text-xs">
                                    <T context="Features">
                                        <li className="flex items-center gap-2">
                                            ...
                                            <span>
                                                Set up simple routines that show
                                                you a daily digest of your
                                                recent saves, and more
                                            </span>
                                        </li>
                                        <li className="flex items-center gap-2">
                        ...
                        <section className="grid w-full grid-cols-1 gap-2 md:grid-cols-2 md:gap-[40px]">
                            <div className="flex max-w-[340px] flex-col gap-3 py-5 md:gap-4">
                                <T context="Feed">
                                    <h2 className="font-medium text-[28px] text-foreground leading-[1.1] tracking-[-1.28px] lg:text-[32px]">
                                        Search and explore from a single, fast
                                        feed
                                    </h2>
                                    <p className="text-pretty font-medium text-base text-foreground leading-[1.2] tracking-[-3%] opacity-50">
                                        Streamline the way you revisit your
                                        saved content through a modern and
                                        powerful interface.
                                    </p>
                                </T>
                                <ul className="mt-2 flex flex-col space-y-2 text-xs">
                                    <T context="Features">
                                        <li className="flex items-center gap-2">
                                            ...
                                            <span>
                                                Use command menu and shortcuts
                                        ...
                                        <li className="flex items-center gap-2">
                                            ...
                                            <span>
                                                Read articles without
                                                distractions using Quick Look
                                            </span>
                                        </li>
                                    </T>
                                </ul>
                            ...
                            <div className="flex max-w-[340px] flex-col gap-3 py-5 md:gap-4">
                                <T>
                                    ...
                                    <p className="text-pretty font-medium text-base text-foreground leading-[1.2] tracking-[-3%] opacity-50">
                                        ...
                                        you've already marked as important.
                                        Import scattered saves once and Cache
                                        organizes them in minutes.
                                    </p>
                                </T>
                                <ul className="mt-2 flex flex-col space-y-2 text-xs">
                                    <T context="Features">
                                        <li className="flex items-center gap-2">
                                            ...
                                            <span>
                                                ...
                                                helps you separate the
                                                actionable from the inspiration
                                            </span>
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <Unlink className="inline-block size-4 shrink-0" />
                                            <span>
                                                Filter duplicates and broken
                                                links
                                            </span>
                                        </li>
                                    </T>
                                        ...
                                        <T context="AI agents demo on homepage">
                                            ...
                                            <div className="flex flex-col gap-1.5 sm:gap-2.5 md:gap-3">
                                                ...
                                                <p className="text-pretty font-medium text-[13px] text-foreground leading-[1.3] tracking-[-0.4px] sm:text-base md:text-lg md:leading-[1.28]">
                                                    ...
                                                    philosophy of life centered
                                                    on deliberate, high-leverage
                                                    action and systematic
                                                    self-optimization.
                                                </p>
                                            </div>
                                        </T>
                            ...
                            <Carousel>
                                ...
                                >
                                    ...
                                    <div className="flex h-96 flex-col justify-between rounded-2xl border border-border/70 bg-background p-6">
                                        ...
                                        <p className="text-pretty font-medium text-[15px] text-foreground leading-[1.4] opacity-50">
                                            <T>
                                                Docs, issues, code, tutorials.
                                                Find that one link instantly.
                                            </T>
                                        </p>
                                    </div>
                                    <div className="flex h-96 flex-col justify-between rounded-2xl border border-border/70 bg-background p-6">
                                        ...
                                        <p className="text-pretty font-medium text-[15px] text-foreground leading-[1.4] opacity-50">
                                            <T>
                                                Threads, videos, inspiration.
                                                Group ideas into collections and
                                                share them.
                                            </T>
                                        </p>
                                    </div>
                                    <div className="flex h-96 flex-col justify-between rounded-2xl border border-border/70 bg-background p-6">
                                        ...
                                        <p className="text-pretty font-medium text-[15px] text-foreground leading-[1.4] opacity-50">
                                            <T>
                                                The missing step between
                                                bookmarking and note-taking.
                                                Structured, searchable, always
                                        ...
                                        <Popover>
                                            ...
                                            <PopoverPopup side="top">
                                                <div className="max-w-xs text-pretty text-sm">
                                                    ...
                                                    for AI, but for software. It
                                                    lets your AI agents securely
                                                    access apps and data, so
                                                    they can take actions and
                                                    get work done for you — all
                                                    without you needing to
                                                    manually intervene.
                                                </div>
                                            </PopoverPopup>
                                        </Popover>{" "}
                                        and empower them with the full spectrum
                                        of your resources
                                    </p>
                                </T>
                            </div>
