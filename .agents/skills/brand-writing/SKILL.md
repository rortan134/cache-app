...
| Use Plain Speech                    | Use Cache Voice            |
| ----------------------------------- | -------------------------- |
...
Cache Voice adds personality in appropriate moments. It's empathetic, self-aware, and occasionally snarky.
...
3. Cache Voice is appropriate here
